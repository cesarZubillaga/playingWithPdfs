...
# Installation of PHPWrapper
Installation of the "mikehaertl/phpwkhtmltopdf": "^2.2" wrapper for the wkhtmltopdf so we
can use it on the PHP code. We need to specify where the binary it's located!
# Options
Must install the last version so all the options are usable:
# Name:
